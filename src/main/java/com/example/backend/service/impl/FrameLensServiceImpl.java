...
//
//            EnabledLens enabledLens = new EnabledLens();
//            enabledLens.lensName = lensList.get(0).getLensName();
//            enabledLens.description = lensList.get(0).getDescription();
//            result.add(enabledLens);
//
//            if ((userLensRequest.leftDegree.equals(0.00))&&(userLensRequest.rightDegree.equals(0.00))){
//                // 仅平光
//                for (Lens l:lensList){
