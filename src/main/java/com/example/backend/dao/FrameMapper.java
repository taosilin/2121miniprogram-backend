...
public interface FrameMapper extends Mapper<Frame> {
    ...
    public List<Frame> findByFrameClass(@Param("state")String state,@Param("classification")String classification,@Param("page")Integer page, @Param("size")Integer size); // 按分类筛选镜框
}
